...
import { verifyPassword, createToken, getSessionCookieBase } from "@/lib/auth";
import {
  logLoginAttempt,
  checkLoginLock,
  registerFailedLogin,
...
function setSessionCookies(
  ...
  response.cookies.set("coresuite-token", token, getSessionCookieBase(maxAge));
  response.cookies.set("coresuite-csrf", csrfToken, {
    ...getSessionCookieBase(60 * 60 * 24),
    httpOnly: false,
  });
}
