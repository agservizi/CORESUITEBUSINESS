...
import { VIEW_THEMES } from "./finance-utils";
...
export default function FinanceViewHero({ viewId, badge, children }: Props) {
  ...
  return (
    ...
    >
      ...
      />
      <Box sx={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 2, alignItems: "flex-start" }}>
        <Box>
          ...
          <Typography sx={{ opacity: 0.9, maxWidth: 420, fontSize: "0.9rem" }}>
            {theme.subtitle}
          </Typography>
          {badge && (
            <Chip
